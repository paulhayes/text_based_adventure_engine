...
Door.link = function(roomA, roomB, props){
	...
	doorA.addCommand( 'go into '+roomB.name, doorA.goThrough, doorA.commandStates.DISCOVERED );
	doorB.addCommand( 'go into '+roomA.name, doorB.goThrough, doorA.commandStates.DISCOVERED );
